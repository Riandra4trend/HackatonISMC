  ...
  return (
      <div className="w-full bg-[#F7F7F7] flex flex-col p-[24px] gap-[24px]">
        ...
        <div className="w-full lg:h-[30%] flex-row flex flex-wrap gap-[24px] justify-center overflow-y-scroll lg:border-b-2 py-[24px]" id="style-2">
          {loader && loader.map((vehicle,index)=>(
            <div key={index} className="w-[300px] h-[120px] bg-white rounded-[16px] flex flex-col justify-center p-[24px] shadow-md">
              <div className="flex-row flex items-center justify-between">  
                <p className="text-gray-400 text-[15px]">{vehicle.assign}</p>
                <div className={!vehicle.is_ready? "rounded-full w-[15px] h-[15px] bg-red-400": "rounded-full w-[15px] h-[15px] bg-green-400"}>
              </div>
            </div>
                <div className="flex gap-1 items-center">
                  ...
                  <p className="text-black font-bold text-[20px]">{vehicle.id}</p>
                </div>

              <div className="flex justify-evenly text-black text-[10px] text-center my-1">
                <div className="w-full">
                  <p>Productivity</p>
                  <p className="text-gray-500">{vehicle.productivity !== 0? vehicle.productivity : "-"}</p>
                </div>
                <div className="w-full">
                  <p>Work Hour</p>
                  <p className="text-gray-500">{vehicle.working_hours}</p>
                </div>
                <div className="w-full">
                  <p>Operator</p>
